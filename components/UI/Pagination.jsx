  ...
  <Button
      ...
      page={page}
        classNames={{
          ...
          item: "w-8 h-8 text-small rounded-none bg-transparent cursor-pointer",
          cursor:
            "bg-linear-to-b shadow-lg from-default-500 to-default-800 dark:from-default-300 dark:to-default-100 text-white font-bold cursor-pointer",
        }}
        total={total}
      />
