    ...
    <div className='fixed left-0 w-[250px] h-full shadow-xl '>
       <div className='font-semibold'>My Account</div>
        <div className='text-sm flex items-center gap-2'>
          <span className='max-w-52 text-ellipsis line-clamp-1'>{userDetail?.name || userDetail?.mobile} <span className='text-medium text-red-600'>{userDetail?.role === "ADMIN" ? "(Admin)" : "" }</span></span>
