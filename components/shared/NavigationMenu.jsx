...
const NavigationMenu = () => {
  return (
    <div className='w-full flex items-center gap-16 nav-clr   py-2   mt-4 absolute top-[72px] md:top-[78px]  lg:top-[110px] px-3  lg:px-12  border-slate-300 z-40 shadow-md  dark:shadow-gray-900'>
      <CategoryMenu />
