...
const CardProduct = ({data}) => {
  ...
  return (
    <Link href={`/products/${data?._id}`} className='py-2 lg:p-4 grid gap-1 lg:gap-3 min-w-36 lg:min-w-52 rounded cursor-pointer border   dark:text-gray-100 dark:border-gray-100' >
